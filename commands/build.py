        ...
        return MenuNode(
            ...
            children=[
                ...
                MenuNode(
                    ...
                    emoji="🔍",
                    action=self._interactive_build,
                ),
            ],
        )

    def _build_all(self) -> bool:
        """Construye todas las funciones"""
        args = Namespace(function=None, function_list=None)
        return self.execute(args)

    def _interactive_build(self) -> bool:
        """Selección interactiva de funciones"""
